...
export default function Sidebar() {
	...
	return (
		<aside className="group/sidebar bg-card border-r shadow-md w-64 transition-all duration-300 flex flex-col min-h-screen [&:has(>input:checked)]:w-16">
			<input type="checkbox" id="toggle-sidebar" className="hidden" title="Toggle Sidebar" />
			<div className="flex-grow overflow-y-auto">
				<div className="p-4 flex items-center justify-between">
					<h1 className="text-2xl font-bold group-[:has(>input:checked)]/sidebar:hidden">
						Dashboard
					</h1>
					<Label
