...
export function NumberPagination({ totalPages, page, pageSize, defaultPageSize, ...props }: NumberPaginationProps) {
  ...
  return (
    <div className='flex items-center justify-between'>
      <Pagination {...props} className='flex-grow'>
        <PaginationContent>
          <PaginationItem>{page > 1 && <PaginationPrevious href={getUpdatedUrl(page - 1)} />}</PaginationItem>
          ...
          <PaginationItem>{page < totalPages && <PaginationNext href={getUpdatedUrl(page + 1)} />}</PaginationItem>
        </PaginationContent>
      </Pagination>
      <div className='ml-4'>
        <Select
